...
namespace MyTimer
{
    public sealed partial class CircleProgress : UserControl
    {
        ...
        public static readonly DependencyProperty SizeProperty =
         DependencyProperty.Register("Size", typeof(double), typeof(CircleProgress), new PropertyMetadata((double)28.0, OnSizePropertyChanged));
        ...
        public static readonly DependencyProperty LineWidthProperty =
            DependencyProperty.Register("LineWidth", typeof(double), typeof(CircleProgress), new PropertyMetadata((double)4.0, OnLineWidthPropertyChanged));
        ...
        public static readonly DependencyProperty ColorProperty =
            DependencyProperty.Register("LineWidth", typeof(Brush), typeof(CircleProgress), new PropertyMetadata(new SolidColorBrush(Colors.White), OnColorPropertyChanged));
